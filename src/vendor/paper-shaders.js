var PaperShaders=(()=>{var v=Object.defineProperty;var b=Object.getOwnPropertyDescriptor;var G=Object.getOwnPropertyNames;var V=Object.prototype.hasOwnProperty;var T=(t,e)=>{for(var i in e)v(t,i,{get:e[i],enumerable:!0})},P=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of G(e))!V.call(t,a)&&a!==i&&v(t,a,{get:()=>e[a],enumerable:!(r=b(e,a))||r.enumerable});return t};var W=t=>P(v({},"__esModule",{value:!0}),t);var K={};T(K,{ShaderFitOptions:()=>w,ShaderMount:()=>d,getShaderColorFromString:()=>Q,getShaderNoiseTexture:()=>C,smokeRingFragmentShader:()=>S});var R=`#version 300 es
...
}`;function N(){let t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function y(t){let e=visualViewport?.scale??1,i=visualViewport?.width??window.innerWidth,r=window.innerWidth-t.documentElement.clientWidth,a=e*i+r,o=outerWidth/a,s=Math.round(100*o);return s%5===0?s/100:s===33?1/3:s===67?2/3:s===133?4/3:o}var w={none:0,contain:1,cover:2};var M=`
...
`;var f={maxColorCount:10,maxNoiseIterations:8},S=`#version 300 es
precision mediump float;
