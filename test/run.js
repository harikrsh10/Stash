...
const SUITES = [
  ...
  { file: 'icns.test.js', runtime: 'node', what: 'an app logo read out of its own bundle' },
  ...
  { file: 'appearance.test.js', runtime: 'node', what: 'switching appearance, and the loop it used to arm' },
